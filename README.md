...
`docker build -t ghcr.io/vroom-project/vroom-docker:v1.15.0-rc.2 --build-arg VROOM_RELEASE=v1.15.0-rc.2 --build-arg VROOM_EXPRESS_RELEASE=v0.12.0 .`
...
- `VROOM_RELEASE`: specifies VROOM's git [branch](https://github.com/VROOM-Project/vroom/branches), [commit hash](https://github.com/VROOM-Project/vroom/commits/master) or [release](https://github.com/VROOM-Project/vroom/releases) (e.g. `v1.15.0-rc.2`) to install in the container
